...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Create a samplesheet from fastq files')
    parser.add_argument('input_directory', help='Input directory containing the fastq files')
